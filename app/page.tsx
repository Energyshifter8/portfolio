            ...
            <div className="space-y-8 mt-16 md:mt-0">
              ...
              <div className="flex flex-col items-start gap-12 pt-4 relative z-50">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="group flex items-center gap-4 border border-white/20 p-4 hover:bg-white/5 transition-colors flex-shrink-0 cursor-pointer -ml-4 md:-ml-12 lg:-ml-20"
                >
